...
export const CallAction = ({ t }) => {
    return (
        <section className="py-24 relative overflow-hidden">
            ...
            {/* Decorative blobs */}
            <div className="absolute top-0 right-0 w-96 h-96 bg-blue-500 rounded-full blur-[100px] opacity-10 pointer-events-none animate-blob" />
            <div className="absolute bottom-0 left-0 w-96 h-96 bg-purple-500 rounded-full blur-[100px] opacity-10 pointer-events-none animate-blob animation-delay-2000" />
